...
vk::event::wall_post_new vk::event::common::get_wall_post_event()   const { return vk::event::wall_post_new(std::move(*_event)["object"]); }
vk::event::wall_reply_new vk::event::common::get_wall_reply_event() const { return vk::event::wall_reply_new(std::move(*_event)["object"]); }
...
std::string vk::event::common::dump()   const noexcept { return simdjson::to_string(*_event); }
